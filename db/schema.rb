...
ActiveRecord::Schema.define(version: 2022_03_09_061321) do
  ...
  create_table "casts", options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
  ...
  create_table "casts_movies", options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.bigint "movie_id"
    t.bigint "cast_id"
  ...
  create_table "genres_movies", options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.bigint "genre_id"
    t.bigint "movie_id"
  ...
  create_table "jwt_denylist", options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
